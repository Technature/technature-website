...
export default function Burger({openModal,opened}) {
    ...
    return (
              ...
              <div className={`cursor-pointer active:bg-gray-100 fixed  top-10 z-50  right-[46px]  md:right-[86px]`} onClick={openModal} onMouseEnter={onEnter} onMouseLeave={onLeave}>
