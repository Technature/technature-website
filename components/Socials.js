    ...
    return (
        ...
        <a href="/" target="_blank" rel="noopener noreferrer">
          <svg className="ml-4 hover:opacity-70 " width="48" height="48" viewBox="0 0 48 48">
            ...
            >
              <g
                className={`fill-transparent stroke-${color}`}
                id="Ellipse_2"
                data-name="Ellipse 2"
                transform="translate(239 664)"
                fill="#fff"
        ...
        <a href="/" target="_blank" rel="noopener noreferrer">
          <svg className="ml-4 hover:opacity-70" width="46" height="48" viewBox="0 0 46 48">
            <g
              id="Group_383"
              data-name="Group 383"
        ...
        <a href="/" target="_blank" rel="noopener noreferrer">
          <svg className="ml-4 hover:opacity-70" width="47" height="48" viewBox="0 0 47 48">
            <g
              id="Group_384"
              data-name="Group 384"
        ...
        <a href="/" target="_blank" rel="noopener noreferrer">
          <svg className="ml-4 hover:opacity-70" height="48" viewBox="0 0 47 48" width="47">
            <g
              className={`fill-transparent stroke-${color}`}
              fill="#fff"
              stroke="#878787"
